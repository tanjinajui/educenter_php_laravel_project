            ...
            <div class="col-xs-12 col-md-6 offset-md-3 js-grid js-sizer">
              <div class="panel">
                <div class="panel-heading bg-faded-darken">
                  <div class="panel-title">Fee Category Edit</div>
                </div>
                <div class="panel-body">
				  ...
				  <!-- laravelcollected html form starts -->
    				{!! Form::open(['url' => '/fee_categories/'.$data_show->id,'method'=>'PATCH']) !!}
				    <!-- year_name field -->
				    <div class="form-group">
				    	<label for="fee_categories_name">Fee Category Name:</label>
				    	<input type="text" name="fee_categories_name" class="form-control" placeholder="Fee Category name" value="{{$data_show->fee_categories_name}}">
				    </div>

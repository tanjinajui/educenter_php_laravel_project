            ...
            <div class="col-xs-12 col-md-6 offset-md-3 js-grid js-sizer">
              <div class="panel">
                <div class="panel-heading bg-faded-darken">
                  <div class="panel-title">Year Edit</div>
                </div>
                <div class="panel-body">
				  ...
				  <!-- laravelcollected html form starts -->
    				{!! Form::open(['url' => '/year/'.$data_show->id,'method'=>'PATCH']) !!}
				    <!-- year_name field -->
				    <div class="form-group">
				    	<label for="year_name">year Name:</label>
				    	<input type="text" name="year_name" class="form-control" placeholder="year name" value="{{$data_show->year_name}}">
				    </div>
